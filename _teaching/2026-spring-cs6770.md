...
* **Project (50%)**: By the end of this course, you are required to complete a research project, present your results, and submit a project report. You are required to work in a team of 2 or 3 students (any team size that deviates from this range requires prior approval from the instructor). There are two acceptable project types:
  ...
  The project grading breakdown (50%) is as follows:
     ...
     * Mid-term report ([<span style="color:blue">**Guideline**</span>](https://docs.google.com/document/d/1FiHoes8pXunxgfp8a67iZ8FNTk42IE3lyP42o2Yiz5w/edit?usp=sharing)): 10% (**Deadline**: 3/13)
     * Final presentation (**Deadline**: 4/19; [<span style="color:blue">**Guideline**</span>](https://docs.google.com/document/d/1PhyxdMSCOjDIQRSUVmRLHRqHWbYWxYN_ra7QPMyN_jo/edit?usp=sharing)) and final report (**Deadline**: 5/5; [<span style="color:blue">**Guideline**</span>](https://docs.google.com/document/d/1D9AXkx21OKKefjRn8K7WdIGYh6lS-M4_fnBmsaypaxQ/edit?usp=sharing)): 35% 
...
<tr>
    ...
    <tr>
      <td >4/6</td>
      <td ><span class="guest">Guest Lecture: <a href="https://yaof20.github.io/">Feng Yao</a> (UCSD & Thinking Machines Lab)</span></td>
      <td>On the Rollout-Training Mismatch in Modern RL Systems</td>
      <td><a href="/teaching/2026-spring-cs6770/guest_lecture_yao.pdf">guest_lecture_yao</a></td>
    </tr>
    <tr>
      <td >4/8</td>
    ...
    <tr>
      <td >4/13</td>
      <td ><span class="tag">No Class</span></td>
      <td>-</td>
      <td>-</td>
    </tr>
    <tr>
