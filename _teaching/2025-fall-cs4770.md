...
| **9** | 10/20 Mon | <span class="guest">(TBD) Guest Lecture: [Songlin Yang (MIT)](https://sustcsonglin.github.io/)</span> | <strong>Project mid-term report due:</strong> 10/20 11:59pm |
|  | 10/22 Wed | Introduction to Large Language Models (LLMs) · [Slides]() · [Slido]() | |
