...
* **Participation (5%+; points earned beyond 5% will become extra credit)**: We encourage everyone to actively participate in the class. There are several ways of earning the participation credit:
  ...
  * **Guest lecture attendance on Zoom (3% each guest lecture)**:
    * We will have guest lectures for this semester
...
|  | 10/15 Wed | Large Language Models (LLMs) & In-context Learning · [Slides]() · [Slido]() | |
| **9** | 10/20 Mon | LLM Scaling Laws · [Slides]() · [Slido]() | |
...
| **12** | 11/10 Mon | Inference-Time Scaling & Reinforcement Learning with Verifiable Rewards (RLVR) · [Slides]() · [Slido]() | |
|  | 11/12 Wed | LLM Agents · [Slides]() · [Slido]() | |
| **13** | 11/17 Mon | <span class="guest">Guest Lecture: TBD</span> | |
