...
<table>
  ...
  <tfoot>
    <tr class="section-header">
      <td colspan="4">Introduction to Large Language Models</td>
    </tr>
  </tfoot>
  <tbody>
    <tr>
  ...
  <tfoot>
    <tr class="section-header">
      <td colspan="4">Reasoning with Language Models</td>
    </tr>
  </tfoot>
  <tbody>
    <!-- Reasoning section rows go here -->
    <tr>
      <td><b>2/3</b></td>
  ...
  <tfoot>
    <tr class="section-header">
      <td colspan="4">Language Agents</td>
    </tr>
  </tfoot>
  <tbody>
    <!-- Add Agent-related rows -->
  </tbody>
</table>
