...
* **Paper Presentation (30%)**: For each lecture, we will ask a group of 2 or 3 students to present 4 papers selected for the corresponding topic. The goal is to educate the rest of the class about the topic. No need to focus on every detail of the papers -- the general ideas and insight matter more!
